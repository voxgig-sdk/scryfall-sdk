...
func (sdk *ScryfallSDK) OptionsMap() map[string]any {
...
func (sdk *ScryfallSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ScryfallSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ScryfallSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ScryfallSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ScryfallSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ScryfallSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ScryfallSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ScryfallSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ScryfallSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ScryfallSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
