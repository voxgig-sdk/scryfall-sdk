...
func NewManaCostEntity(client *core.ScryfallSDK, entopts map[string]any) *ManaCostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ManaCostEntity) GetName() string { return e.name }
...
func (e *ManaCostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ManaCostEntity) Deleted() bool {
	return e.deleted
}


func (e *ManaCostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewManaCostEntity(e.client, opts)
}

func (e *ManaCostEntity) Data(args ...any) any {
...
func (e *ManaCostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ManaCost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ManaCostEntity) DataTyped(data ...ManaCost) ManaCost {
	if len(data) > 0 {
		return typedFrom[ManaCost](e.Data(asMap(data[0])))
	}
	return typedFrom[ManaCost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ManaCost (all fields
// optional at the wire level).
func (e *ManaCostEntity) MatchTyped(match ...ManaCost) ManaCost {
	if len(match) > 0 {
		return typedFrom[ManaCost](e.Match(asMap(match[0])))
	}
	return typedFrom[ManaCost](e.Match())
}
...
func (e *ManaCostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ManaCostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ManaCostEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ManaCostListMatch and returns []ManaCost. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ManaCostEntity) ListTyped(reqmatch ManaCostListMatch, ctrl map[string]any) ([]ManaCost, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ManaCost](res), nil
}



func (e *ManaCostEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ManaCostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ManaCostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ManaCostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
