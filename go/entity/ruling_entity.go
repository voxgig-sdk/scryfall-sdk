...
func NewRulingEntity(client *core.ScryfallSDK, entopts map[string]any) *RulingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RulingEntity) GetName() string { return e.name }
...
func (e *RulingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RulingEntity) Deleted() bool {
	return e.deleted
}


func (e *RulingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRulingEntity(e.client, opts)
}

func (e *RulingEntity) Data(args ...any) any {
...
func (e *RulingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ruling; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RulingEntity) DataTyped(data ...Ruling) Ruling {
	if len(data) > 0 {
		return typedFrom[Ruling](e.Data(asMap(data[0])))
	}
	return typedFrom[Ruling](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ruling (all fields
// optional at the wire level).
func (e *RulingEntity) MatchTyped(match ...Ruling) Ruling {
	if len(match) > 0 {
		return typedFrom[Ruling](e.Match(asMap(match[0])))
	}
	return typedFrom[Ruling](e.Match())
}
...
func (e *RulingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RulingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RulingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RulingListMatch and returns []Ruling. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RulingEntity) ListTyped(reqmatch RulingListMatch, ctrl map[string]any) ([]Ruling, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Ruling](res), nil
}



func (e *RulingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RulingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RulingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RulingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
