...
func NewCardListEntity(client *core.ScryfallSDK, entopts map[string]any) *CardListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardListEntity) GetName() string { return e.name }
...
func (e *CardListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardListEntity) Deleted() bool {
	return e.deleted
}


func (e *CardListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardListEntity(e.client, opts)
}

func (e *CardListEntity) Data(args ...any) any {
...
func (e *CardListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardListEntity) DataTyped(data ...CardList) CardList {
	if len(data) > 0 {
		return typedFrom[CardList](e.Data(asMap(data[0])))
	}
	return typedFrom[CardList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardList (all fields
// optional at the wire level).
func (e *CardListEntity) MatchTyped(match ...CardList) CardList {
	if len(match) > 0 {
		return typedFrom[CardList](e.Match(asMap(match[0])))
	}
	return typedFrom[CardList](e.Match())
}
...
func (e *CardListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CardListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardListListMatch and returns []CardList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CardListEntity) ListTyped(reqmatch CardListListMatch, ctrl map[string]any) ([]CardList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CardList](res), nil
}




func (e *CardListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CardListCreateData and returns an CardList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CardListEntity) CreateTyped(reqdata CardListCreateData, ctrl map[string]any) (CardList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CardList{}, err
	}
	return typedFrom[CardList](res), nil
}



func (e *CardListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
