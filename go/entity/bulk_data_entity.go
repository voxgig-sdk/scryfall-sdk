...
func NewBulkDataEntity(client *core.ScryfallSDK, entopts map[string]any) *BulkDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BulkDataEntity) GetName() string { return e.name }
...
func (e *BulkDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BulkDataEntity) Deleted() bool {
	return e.deleted
}


func (e *BulkDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBulkDataEntity(e.client, opts)
}

func (e *BulkDataEntity) Data(args ...any) any {
...
func (e *BulkDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BulkDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BulkDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *BulkDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BulkDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BulkDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BulkDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
