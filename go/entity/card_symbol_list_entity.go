...
type CardSymbolListEntity struct {
	name    string
	client  *core.ScryfallSDK
...
func NewCardSymbolListEntity(client *core.ScryfallSDK, entopts map[string]any) *CardSymbolListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardSymbolListEntity) GetName() string { return e.name }
...
func (e *CardSymbolListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardSymbolListEntity) Deleted() bool {
	return e.deleted
}


func (e *CardSymbolListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardSymbolListEntity(e.client, opts)
}

func (e *CardSymbolListEntity) Data(args ...any) any {
...
func (e *CardSymbolListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardSymbolList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardSymbolListEntity) DataTyped(data ...CardSymbolList) CardSymbolList {
	if len(data) > 0 {
		return typedFrom[CardSymbolList](e.Data(asMap(data[0])))
	}
	return typedFrom[CardSymbolList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardSymbolList (all fields
// optional at the wire level).
func (e *CardSymbolListEntity) MatchTyped(match ...CardSymbolList) CardSymbolList {
	if len(match) > 0 {
		return typedFrom[CardSymbolList](e.Match(asMap(match[0])))
	}
	return typedFrom[CardSymbolList](e.Match())
}
...
func (e *CardSymbolListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardSymbolListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CardSymbolListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardSymbolListListMatch and returns []CardSymbolList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CardSymbolListEntity) ListTyped(reqmatch CardSymbolListListMatch, ctrl map[string]any) ([]CardSymbolList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CardSymbolList](res), nil
}



func (e *CardSymbolListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CardSymbolListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardSymbolListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardSymbolListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
