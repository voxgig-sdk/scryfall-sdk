...
func TestMigrationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		migrationRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath("existing.migration", setup.data)))
...
func migrationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SCRYFALL_TEST_MIGRATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SCRYFALL_TEST_MIGRATION_ENTID"])
