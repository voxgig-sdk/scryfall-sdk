...
const testSeed = `map[string]any{"entity": map[string]any{"bulk_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_symbol_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "catalog": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mana_cost": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "migration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ruling": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "set": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
