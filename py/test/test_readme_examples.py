# Scryfall SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ScryfallSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ScryfallSDK(...) and ScryfallSDK.test(...) become
#      ScryfallSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "scryfall_sdk"
_SDK_CLASS = "ScryfallSDK"
