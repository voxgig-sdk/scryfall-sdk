...
class CardListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardListEntity(self._client, opts)
    ...
    def create(self, reqdata: CardListCreateData, ctrl=None) -> CardList:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
