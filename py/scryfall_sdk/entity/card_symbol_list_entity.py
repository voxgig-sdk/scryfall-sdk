...
class CardSymbolListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardSymbolListEntity(self._client, opts)
    ...
    def data_get(self) -> CardSymbolList:
    ...
    def match_get(self) -> CardSymbolList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CardSymbolList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CardSymbolList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
