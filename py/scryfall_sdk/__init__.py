...
from scryfall_sdk.utility import register

# Load features
from scryfall_sdk.feature.base_feature import ScryfallBaseFeature
from scryfall_sdk.features import _has_feature, _make_feature
...
class ScryfallSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ScryfallSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ruling(self, data=None) -> "RulingEntity":
        ...
        from scryfall_sdk.entity.ruling_entity import RulingEntity
        return RulingEntity(self, data)


    def Set(self, data=None) -> "SetEntity":
        """Entity factory: client.Set().list() / client.Set().load({"id": ...})."""
        from scryfall_sdk.entity.set_entity import SetEntity
