...
class ScryfallFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ScryfallSDK/1.0)';
    ...
    public static function call(ScryfallContext $ctx, string $fullurl, array $fetchdef): array
    {
