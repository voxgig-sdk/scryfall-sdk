...
// Scryfall SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ScryfallMakeRequest
{
    public static function call(ScryfallContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ScryfallResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ScryfallResponse($fetched);
        } else {
