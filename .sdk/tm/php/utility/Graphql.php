...
class ScryfallGraphql
{
    ...
    // equivalent.
    public static function body(ScryfallContext $ctx): mixed
    {
    ...
    public static function errors(ScryfallContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
