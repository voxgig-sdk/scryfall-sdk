...
class ScryfallProxyFeature extends ScryfallBaseFeature
{
    ...
    public function init(ScryfallContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ScryfallContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
