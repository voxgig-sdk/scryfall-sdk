...
// Scryfall SDK clienttrack feature
...
class ScryfallClienttrackFeature extends ScryfallBaseFeature
{
    ...
    public function PostConstruct(ScryfallContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Scryfall-SDK';
