...
class ScryfallNetsimFeature extends ScryfallBaseFeature
{
    ...
    private function _simulate(ScryfallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ScryfallContext $ctx, array $applied): void
    {
        $client = $this->client;
