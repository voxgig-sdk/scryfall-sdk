...
from projectname_sdk.core.control import ScryfallControl
...
class ScryfallContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ScryfallResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ScryfallResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ScryfallError(code, msg, self)
