...
|---|---|---|
| `ts/` | @voxgig-sdk/scryfall-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/scryfall-sdk \
      --repository voxgig-sdk/scryfall-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/scryfall-sdk` shows it, and
`npm trust revoke @voxgig-sdk/scryfall-sdk --id=<id>` removes it.
