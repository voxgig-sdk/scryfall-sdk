...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/scryfall` | `npm install @voxgig-sdk/scryfall` |
| Python | `voxgig-sdk-scryfall` | `pip install voxgig-sdk-scryfall` |
| PHP | `voxgig-sdk/scryfall` | `composer require voxgig-sdk/scryfall` |
| Golang | `github.com/voxgig-sdk/scryfall-sdk/go` | `go get github.com/voxgig-sdk/scryfall-sdk/go` |
| Ruby | `voxgig-sdk-scryfall` | `gem install voxgig-sdk-scryfall` |
| Lua | `voxgig-sdk-scryfall` | `luarocks install voxgig-sdk-scryfall` |
