...
class ManaCostDirectTest extends TestCase
{
    public function test_direct_list_mana_cost(): void
    {
        $setup = mana_cost_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-mana_cost", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
