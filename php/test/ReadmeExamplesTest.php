...
// Scryfall SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ScryfallSDK::test)
...
{
    private const SDK_CLASS = 'ScryfallSDK';
    ...
    private const SDK_BASE = 'scryfall_sdk';
