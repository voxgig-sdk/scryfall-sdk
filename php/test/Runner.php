...
class ScryfallTestRunner
{
    ...
    {
        $live = self::getenv('SCRYFALL_TEST_LIVE');
        $override = self::getenv('SCRYFALL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SCRYFALL_TEST_EXPLAIN');
...
class_alias('ScryfallTestRunner', 'Runner');
class_alias('ScryfallHelpers', 'Helpers');
