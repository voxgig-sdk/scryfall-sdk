...
class RulingDirectTest extends TestCase
{
    public function test_direct_list_ruling(): void
    {
        $setup = ruling_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-ruling", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
