...
// Scryfall SDK streaming feature
...
class ScryfallStreamingFeature extends ScryfallBaseFeature
{
    ...
    private function _iterate(ScryfallResult $result): \Generator
    {
    ...
    private function _streamable(ScryfallContext $ctx): bool
    {
