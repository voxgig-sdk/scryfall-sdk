...
class ScryfallRbacFeature extends ScryfallBaseFeature
{
    ...
    private function _required(ScryfallContext $ctx): ?string
    {
    ...
    private function _reject(ScryfallContext $ctx, string $required): void
    {
    ...
    private function _track(ScryfallContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
