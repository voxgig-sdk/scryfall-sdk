...
class ScryfallCacheFeature extends ScryfallBaseFeature
{
    ...
    private function _through(ScryfallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
