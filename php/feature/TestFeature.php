...
// Scryfall SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ScryfallTestFeature extends ScryfallBaseFeature
{
    ...
    public function init(ScryfallContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ScryfallContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ScryfallContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ScryfallContext $ctx, $op, $args): array
    {
