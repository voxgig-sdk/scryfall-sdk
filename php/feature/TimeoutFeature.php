...
class ScryfallTimeoutFeature extends ScryfallBaseFeature
{
    ...
    private function _with_timeout(ScryfallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ScryfallContext $_ctx, float $ms): void
    {
        $client = $this->client;
