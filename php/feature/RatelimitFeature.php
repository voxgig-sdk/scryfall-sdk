...
// Scryfall SDK ratelimit feature
...
class ScryfallRatelimitFeature extends ScryfallBaseFeature
{
    ...
    private function _acquire(ScryfallContext $ctx): void
    {
    ...
    private function _track(ScryfallContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
