...
// Scryfall SDK CardSymbolList entity
...
class CardSymbolListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CardSymbolListEntity($this->_client, $opts);
    }

    /**
     * @param CardSymbolList|array $args CardSymbolList data (assoc-array) to store.
     */
    ...
    /**
     * @return CardSymbolList|array The current CardSymbolList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CardSymbolList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CardSymbolList fields).
     */
    ...
    /**
     * List CardSymbolList items matching the given filter.
     *
     * @param CardSymbolListListMatch|array|null $reqmatch Match filter (any subset
     *   of CardSymbolList fields) as an assoc-array; CardSymbolListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardSymbolList[]|array A list of CardSymbolList items as assoc-arrays at
