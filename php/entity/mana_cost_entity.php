...
class ManaCostEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ManaCostEntity($this->_client, $opts);
    }

    /**
     * @param ManaCost|array $args ManaCost data (assoc-array) to store.
     */
    ...
    /**
     * @return ManaCost|array The current ManaCost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ManaCost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ManaCost fields).
     */
     ...
     *
     * @param ManaCostListMatch|array|null $reqmatch Match filter (any subset
     *   of ManaCost fields) as an assoc-array; ManaCostListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ManaCost[]|array A list of ManaCost items as assoc-arrays at
