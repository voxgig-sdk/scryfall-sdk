...
-- data to return.
local TEST_SEED = '{ entity = { ["bulk_data"] = { ["test01"] = { id = "test01" } }, ["card"] = { ["test01"] = { id = "test01" } }, ["card_list"] = { ["test01"] = { id = "test01" } }, ["card_symbol_list"] = { ["test01"] = { id = "test01" } }, ["catalog"] = { ["test01"] = { id = "test01" } }, ["mana_cost"] = { ["test01"] = { id = "test01" } }, ["migration"] = { ["test01"] = { id = "test01" } }, ["ruling"] = { ["test01"] = { id = "test01" } }, ["set"] = { ["test01"] = { id = "test01" } } } }'
