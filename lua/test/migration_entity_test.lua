...
describe("MigrationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SCRYFALL_TEST_MIGRATION_ENTID JSON to run live")
      return
    end
...
function migration_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SCRYFALL_TEST_MIGRATION_ENTID")
