...
describe("ManaCostDirect", function()
  it("should direct-list-mana_cost", function()
    local setup = mana_cost_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-mana_cost", setup.live and "live" or "unit")
...
function mana_cost_direct_setup(mockres)
