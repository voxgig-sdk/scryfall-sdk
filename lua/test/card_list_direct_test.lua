...
describe("CardListDirect", function()
  it("should direct-list-card_list", function()
    local setup = card_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-card_list", setup.live and "live" or "unit")
...
function card_list_direct_setup(mockres)
