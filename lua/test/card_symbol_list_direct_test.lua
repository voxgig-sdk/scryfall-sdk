...
describe("CardSymbolListDirect", function()
  it("should direct-list-card_symbol_list", function()
    local setup = card_symbol_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-card_symbol_list", setup.live and "live" or "unit")
...
function card_symbol_list_direct_setup(mockres)
