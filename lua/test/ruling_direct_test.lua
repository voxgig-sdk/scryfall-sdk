...
describe("RulingDirect", function()
  it("should direct-list-ruling", function()
    local setup = ruling_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ruling", setup.live and "live" or "unit")
...
function ruling_direct_setup(mockres)
