...
local BulkDataEntity = {}
BulkDataEntity.__index = BulkDataEntity


function BulkDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BulkDataEntity)
  self._name = "bulk_data"
  self._client = client
...
function BulkDataEntity:get_name()
  return self._name
end


function BulkDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BulkDataEntity.new(self._client, opts)
end
...
function BulkDataEntity:mark_deleted()
  self._deleted = true
end


function BulkDataEntity:deleted()
  return true == self._deleted
end


function BulkDataEntity:data_set(args)
  if args ~= nil then
...
function BulkDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BulkDataEntity:match_set(args)
  if args ~= nil then
...
function BulkDataEntity:match_get()
...
function BulkDataEntity:stream(action, args, callopts)
...
function BulkDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
