...
local CardSymbolListEntity = {}
CardSymbolListEntity.__index = CardSymbolListEntity


function CardSymbolListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CardSymbolListEntity)
  self._name = "card_symbol_list"
  self._client = client
...
function CardSymbolListEntity:get_name()
  return self._name
end


function CardSymbolListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CardSymbolListEntity.new(self._client, opts)
end
...
function CardSymbolListEntity:mark_deleted()
  self._deleted = true
end


function CardSymbolListEntity:deleted()
  return true == self._deleted
end


function CardSymbolListEntity:data_set(args)
  if args ~= nil then
...
function CardSymbolListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CardSymbolListEntity:match_set(args)
  if args ~= nil then
...
function CardSymbolListEntity:match_get()
...
function CardSymbolListEntity:stream(action, args, callopts)
...
---@param reqmatch CardSymbolListListMatch
---@param ctrl? table
---@return CardSymbolList[]
---@return string? err
function CardSymbolListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CardSymbolListEntity:_run_op(ctx, post_done)
  local utility = self._utility
