...
module ScryfallTestRunner
  ...
  def self.env_override(m)
    live = getenv("SCRYFALL_TEST_LIVE")
    override = getenv("SCRYFALL_TEST_OVERRIDE")
    ...
    explain = getenv("SCRYFALL_TEST_EXPLAIN")
    m["SCRYFALL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ScryfallTestRunner
Helpers = ScryfallHelpers
Vs = VoxgigStruct
