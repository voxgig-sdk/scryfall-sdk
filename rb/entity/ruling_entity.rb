...
class RulingEntity
  ...
  # @return [Ruling, Hash] the current Ruling data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ruling fields)
  def match_get
  ...
  #
  # @param reqmatch [RulingListMatch, Hash, nil] match filter (any subset of
  #   Ruling fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ruling>, Array] the matching Ruling items; raises ScryfallError on failure
