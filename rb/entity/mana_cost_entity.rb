...
class ManaCostEntity
  ...
  def make
    opts = @_entopts.dup
    ManaCostEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ManaCostListMatch, Hash, nil] match filter (any subset of
  #   ManaCost fields); defaults to nil, treated as an empty match that lists all.
