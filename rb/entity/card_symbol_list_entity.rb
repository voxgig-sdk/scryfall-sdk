...
class CardSymbolListEntity
  ...
  def make
    opts = @_entopts.dup
    CardSymbolListEntity.new(@_client, opts)
  end
  ...
  # @return [CardSymbolList, Hash] the current CardSymbolList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CardSymbolList fields)
  def match_get
  ...
  #
  # @param reqmatch [CardSymbolListListMatch, Hash, nil] match filter (any subset of
  #   CardSymbolList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CardSymbolList>, Array] the matching CardSymbolList items; raises ScryfallError on failure
