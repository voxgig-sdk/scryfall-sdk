...
function envOverride(m) {
    if ('TRUE' === process.env.SCRYFALL_TEST_LIVE ||
        'TRUE' === process.env.SCRYFALL_TEST_OVERRIDE) {
    ...
    m.SCRYFALL_TEST_EXPLAIN = process.env.SCRYFALL_TEST_EXPLAIN || m.SCRYFALL_TEST_EXPLAIN;
    return m;
}
