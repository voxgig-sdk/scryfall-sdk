...
(0, node_test_1.describe)('CardListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-card_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-card_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SCRYFALL_TEST_CARD_LIST_ENTID'];
...
//# sourceMappingURL=CardListDirect.test.js.map