...
(0, node_test_1.describe)('CardSymbolListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-card_symbol_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-card_symbol_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SCRYFALL_TEST_CARD_SYMBOL_LIST_ENTID'];
...
//# sourceMappingURL=CardSymbolListDirect.test.js.map