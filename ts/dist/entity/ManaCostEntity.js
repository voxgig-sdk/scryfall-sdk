...
class ManaCostEntity extends ScryfallEntityBase_1.ScryfallEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'mana_cost';
        this.name_ = 'mana_cost';
        this.Name = 'ManaCost';
    }
    make() {
        return new ManaCostEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<ManaCost[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.ManaCostEntity = ManaCostEntity;
//# sourceMappingURL=ManaCostEntity.js.map