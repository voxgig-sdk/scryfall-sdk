...
exports.SDK = exports.ScryfallSDK = exports.ScryfallEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
const RulingEntity_1 = require("./entity/RulingEntity");
const SetEntity_1 = require("./entity/SetEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const ScryfallEntityBase_1 = require("./ScryfallEntityBase");
Object.defineProperty(exports, "ScryfallEntityBase", { enumerable: true, get: function () { return ScryfallEntityBase_1.ScryfallEntityBase; } });
...
class ScryfallSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('ScryfallSDK: graphql: ' +
    ...
    BulkData(entopts) {
        const self = this;
        return new BulkDataEntity_1.BulkDataEntity(self, entopts);
    }
    ...
    ManaCost(entopts) {
        const self = this;
        return new ManaCostEntity_1.ManaCostEntity(self, entopts);
    }
    ...
    Ruling(entopts) {
        const self = this;
        return new RulingEntity_1.RulingEntity(self, entopts);
    }
    ...
    Set(entopts) {
        const self = this;
        return new SetEntity_1.SetEntity(self, entopts);
    }
...
exports.ScryfallSDK = ScryfallSDK;
const SDK = ScryfallSDK;
exports.SDK = SDK;
//# sourceMappingURL=ScryfallSDK.js.map